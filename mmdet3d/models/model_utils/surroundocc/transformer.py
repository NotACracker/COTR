...
class PerceptionTransformerSurroundOcc(BaseModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PerceptionTransformerSurroundOcc, self).__init__(**kwargs)
    ...
    def forward(self, mlvl_feats, volume_queries, volume_h, volume_w, volume_z, img_metas, **kwargs):
