...
class MyCustomBaseTransformerLayerSurroundOcc(BaseModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(MyCustomBaseTransformerLayerSurroundOcc, self).__init__(init_cfg)

        self.batch_first = batch_first

        assert set(operation_order) & set(["self_attn", "norm", "ffn", "cross_attn", "conv"]) == set(operation_order), (
